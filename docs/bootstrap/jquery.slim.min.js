...
!function(e, t) {
  ...
  !function() {
      var e, x, w, o, a, C, r, T, p, i, E = me, k = ce.expando, S = 0, n = 0, s = W(), c = W(), u = W(), h = W(), l = function(e, t) {
          return e === t && (a = !0),
          0
      }, f = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", t = "(?:\\\\[\\da-fA-F]{1,6}" + ge + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", d = "\\[" + ge + "*(" + t + ")(?:" + ge + "*([*^$|!~]?=)" + ge + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + t + "))|)" + ge + "*\\]", g = ":(" + t + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + d + ")*)|.*)\\)|)", v = new RegExp(ge + "+","g"), y = new RegExp("^" + ge + "*," + ge + "*"), m = new RegExp("^" + ge + "*([>+~]|" + ge + ")" + ge + "*"), b = new RegExp(ge + "|>"), A = new RegExp(g), D = new RegExp("^" + t + "$"), N = {
          ID: new RegExp("^#(" + t + ")"),
          CLASS: new RegExp("^\\.(" + t + ")"),
          TAG: new RegExp("^(" + t + "|[*])"),
          ATTR: new RegExp("^" + d),
      ...
      function V(e) {
          ...
          return n != C && 9 === n.nodeType && n.documentElement && (r = (C = n).documentElement,
          T = !ce.isXMLDoc(C),
      ...
      (x = ce.expr = {
          ...
          preFilter: {
              ...
              PSEUDO: function(e) {
                  var t, n = !e[6] && e[2];
                  return N.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && A.test(n) && (t = Y(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                  e[2] = n.slice(0, t)),
                  e.slice(0, 3))
              }
          },
              ...
              CHILD: function(p, e, t, h, g) {
                  ...
                  : function(e, t, n) {
                      ...
                      if (l) {
                          ...
                          } else if (f && (d = a = (r = (i = e[k] || (e[k] = {}))[p] || [])[0] === S && r[1]),
                          !1 === d)
                              while (o = ++a && o && o[u] || (d = a = 0) || s.pop())
                                  if ((m ? fe(o, c) : 1 === o.nodeType) && ++d && (f && ((i = o[k] || (o[k] = {}))[p] = [S, d]),
                                  o === e))
                                      break;
      ...
      function Y(e, t) {
          ...
          while (a) {
              ...
              a = a.slice(n.length)),
              x.filter)
                  !(r = N[o].exec(a)) || u[o] && !(r = u[o](r)) || (n = r.shift(),
                  i.push({
                      value: n,
                      type: o,
                      matches: r
      ...
      function ee(p, h, g, v, y, e) {
          ...
          B(function(e, t, n, r) {
              ...
              if (g ? g(d, s = y || (e ? p : c || v) ? [] : t, n, r) : s = d,
              v) {
                  i = Z(s, l),
                  v(i, [], n, r),
                  o = i.length;
  ...
  ce.each({
      ...
      ce.fn[r] = function(e, t) {
          ...
          1 < this.length && (A[r] || ce.uniqueSort(n),
          S.test(r) && n.reverse()),
          this.pushStack(n)
      }
  });
  ...
  ce.extend({
                          ...
                          var n = this
                            ...
                            , e = function() {
                              ...
                              if (!(i < u)) {
                                  ...
                                  v(t) ? s ? t.call(e, l(u, o, L, s), l(u, o, j, s)) : (u++,
                                  t.call(e, l(u, o, L, s), l(u, o, j, s), l(u, o, L, o.notifyWith))) : (a !== L && (n = void 0,
                                  r = [e]),
                                  (s || o.resolveWith)(n, r))
                              }
                          }
      ...
      when: function(e) {
          ...
          if (n <= 1 && (O(e, o.done(a(t)).resolve, o.reject, !n),
  ...
  "complete" === m.readyState || "loading" !== m.readyState && !m.documentElement.doScroll ? ie.setTimeout(ce.ready) : (m.addEventListener("DOMContentLoaded", q),
  ...
  function V(e, t, n) {
      ...
      if (void 0 === n && 1 === e.nodeType)
          if (r = "data-" + t.replace(X, "-$&").toLowerCase(),
  ...
  function ne(e, t) {
      for (var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++)
          ...
          a = (i = r).ownerDocument,
          s = i.nodeName,
          (u = te[s]) || (o = a.body.appendChild(a.createElement(s)),
          u = ce.css(o, "display"),
          o.parentNode.removeChild(o),
          "none" === u && (u = "block"),
          te[s] = u)))) : "none" !== n && (l[c] = "none",
          _.set(r, "display", n)));
      for (c = 0; c < f; c++)
          ...
          if (v && (u = v.events)) {
              ...
              while (l--)
                  ...
                  p) {
                      ...
                      a && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, v.handle) || ce.removeEvent(e, p, v.handle),
                      delete u[p])
                  } else
                      for (p in u)
      ...
      ce.event.special[i] = {
          ...
          teardown: function() {
              var e = this.ownerDocument || this.document || this
                , t = m.documentMode ? this : e
                , n = _.get(t, i) - 1;
              n ? _.set(t, i, n) : (m.documentMode ? this.removeEventListener(i, o) : e.removeEventListener(r, o, !0),
              _.remove(t, i))
          }
      }
  }),
  ...
  function Fe(e, t, n) {
      for (var r, i = t ? ce.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
          ...
          r.parentNode && (n && J(r) && ke(Ee(r, "script")),
      ...
      clone: function(e, t, n) {
          ...
          if (t)
              if (n)
                  ...
                  We(e, c);
          return 0 < (a = Ee(c, "script")).length && ke(a, !f && Ee(e, "script")),
          c
      },
  ...
  ce.fn.extend({
      ...
      empty: function() {
          for (var e, t = 0; null != (e = this[t]); t++)
              1 === e.nodeType && (ce.cleanData(Ee(e, !1)),
              e.textContent = "");
          return this
      },
      clone: function(e, t) {
      ...
      html: function(e) {
          return R(this, function(e) {
              ...
              if ("string" == typeof e && !Pe.test(e) && !Te[(we.exec(e) || ["", ""])[1].toLowerCase()]) {
                  ...
                  try {
                      for (; n < r; n++)
                          1 === (t = this[n] || {}).nodeType && (ce.cleanData(Ee(t, !1)),
                          t.innerHTML = e);
                      t = 0
                  } catch (e) {}
              }
      ...
      replaceWith: function() {
          ...
          return Be(this, arguments, function(e) {
              ...
              ce.inArray(this, n) < 0 && (ce.cleanData(Ee(this)),
  ...
  function Ve(e, t, n) {
      ...
      !le.pixelBoxStyles() && $e.test(a) && Xe.test(t) && (r = u.width,
      i = u.minWidth,
      o = u.maxWidth,
  ...
  function ot(e, t, n, r, i, o) {
      ...
      for (; a < 4; a += 2)
          ...
          r ? ("content" === n && (u -= ce.css(e, "padding" + G[a], !0, i)),
          "margin" !== n && (u -= ce.css(e, "border" + G[a] + "Width", !0, i))) : (u += ce.css(e, "padding" + G[a], !0, i),
  ...
  ce.each(["height", "width"], function(e, u) {
      ce.cssHooks[u] = {
          ...
          set: function(e, t, n) {
              ...
              return a && o && (s -= Math.ceil(e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - ot(e, u, "border", !1, i) - .5)),
  ...
  ce.extend({
      attr: function(e, t, n) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
              return "undefined" == typeof e.getAttribute ? ce.prop(e, t, n) : (1 === o && ce.isXMLDoc(e) || (i = ce.attrHooks[t.toLowerCase()] || (ce.expr.match.bool.test(t) ? st : void 0)),
  ...
  ce.fn.extend({
      ...
      toggleClass: function(t, n) {
          ...
          }) : "boolean" == typeof n && s ? n ? this.addClass(t) : this.removeClass(t) : (e = pt(t),
          this.each(function() {
              if (s)
                  for (o = ce(this),
                  i = 0; i < e.length; i++)
  ...
  ce.extend(ce.event, {
      trigger: function(e, t, n, r) {
          var i, o, a, s, u, l, c, f, d = [n || m], p = ue.call(e, "type") ? e.type : e, h = ue.call(e, "namespace") ? e.namespace.split(".") : [];
          if (o = f = a = n = n || m,
          3 !== n.nodeType && 8 !== n.nodeType && !gt.test(p + ce.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(),
          h.sort()),
          u = p.indexOf(":") < 0 && "on" + p,
          ...
          r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
              if (!r && !c.noBubble && !y(n)) {
                  ...
                  gt.test(s + p) || (o = o.parentNode); o; o = o.parentNode)
                      d.push(o),
                      a = o;
              ...
              return e.type = p,
              r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !F(n) || u && v(n[p]) && !y(n) && ((a = n[u]) && (n[u] = null),
  ...
  ,
  le.createHTMLDocument = ((yt = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
  2 === yt.childNodes.length),
  ce.parseHTML = function(e, t, n) {
      return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t,
      t = !1),
      t || (le.createHTMLDocument ? ((r = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href,
      t.head.appendChild(r)) : t = m),
      o = !n && [],
      (i = C.exec(e)) ? [t.createElement(i[1])] : (i = Ae([e], t, o),
